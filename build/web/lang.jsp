<%-- 
    Document   : lang
    Created on : Nov 28, 2014, 10:23:23 PM
    Author     : SONGSONG
--%>
    ...
    <main>
        ...
        <div class="contain">
          ...
          <div class='col-remaining'>
                <div class="skill">
                	<img src="icon/skill_kor.png" width="300" height="224" alt=""/> 
                    <div class="find">
                    <% 
                    if (session.getAttribute("login") == null) {
                    %><a href="Signin.html">
                ...
                <div class="skill">
                	<img src="icon/skill_jap.png" width="300" height="224" alt=""/> 
                    <div class="find">
                    <% 
                    if (session.getAttribute("login") == null) {
                    %><a href="Signin.html">
                ...
                <div class="skill">
                	<img src="icon/skill_fre.png" width="300" height="224" alt=""/> 
                    <div class="find">
                    <% 
                    if (session.getAttribute("login") == null) {
                    %><a href="Signin.html">
                ...
                <div class="skill">
                	<img src="icon/skill_eng.png" width="300" height="224" alt=""/> 
                    <div class="find">
                    <% 
                    if (session.getAttribute("login") == null) {
                    %><a href="Signin.html">
                ...
                <div class="skill">
                	<img src="icon/skill_chi.png" width="300" height="224" alt=""/> 
                    <div class="find">
                    <% 
                    if (session.getAttribute("login") == null) {
                    %><a href="Signin.html">
                ...
                <div class="skill">
                	<img src="icon/skill_can.png" width="300" height="224" alt=""/> 
                    <div class="find">
                    <% 
                    if (session.getAttribute("login") == null) {
                    %><a href="Signin.html">
